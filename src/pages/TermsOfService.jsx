        ...
        <ol className="flex flex-col gap-[4rem] text-2xl list-decimal list-inside">
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              ...
              <li>
                ...
                links to third-party websites. Five Clover Hotel Ilupeju is not
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                of Five Clover Hotel Ilupeju or its licensors and is protected by
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                your own risk. Five Clover Hotel Ilupeju does not warrant that the
                website will be error-free or that access will be
                uninterrupted. The information provided is on an "as-is"
                basis.
              </li>
              <li>
                <strong>Limitation of Liability:</strong> Five Clover Hotel Ilupeju shall
          ...
          <li>
            ...
            <p className="mt-[1.5rem]">
              ...
              <a
                href="mailto:info@fivecloverhotel.com"
                className="underline text-[color:var(--emphasis)]"
              >
                info@fivecloverhotel.com
              </a>
              .
            </p>
          </li>
