    ...
    >
      ...
      <div className="flex max-sm:flex-col gap-[2rem]">
        <p className="font-secondary text-3xl mx-[1rem] font-bold">
          23 Town Planning Way, Lagos, Lagos 102215
        </p>
        <a
          data-component="Map link"
          href="https://maps.google.com/?q=23+Town+Planning+Way,+Lagos,+Lagos+102215"
          target="_blank"
